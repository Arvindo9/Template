...
public class AppPreferences implements PreferencesService {
    ...
    private static final String PREF_KEY_APPLICATION_CODE = "PREF_KEY_APPLICATION_CODE";
    ...
    public String getApplicationId() {
        return pref.getString(PREF_KEY_APPLICATION_CODE, "");
    }

    @Override
    public void setApplicationId(String id) {
        pref.edit().putString(PREF_KEY_APPLICATION_CODE, id).apply();
    }
