...
import com.aiprog.template.databinding.FlagDialogBinding;
...
//    public static FlagDialog newInstance(ArrayList<Flag> flagList, FlagCallBack flagCallBack) {
     ...
     */
    @Override
    public FlagViewModel getViewModel() {
        return viewModel = ViewModelProviders.of(this,factory).get(FlagViewModel.class);
    }
